...
if page == "form":
    ...
    with st.form("formulario_mascota"):
        ...
        if not VerificarMascota.nombre(nombre):
            st.warning("El nombre de la mascota debe iniciar con mayúscula y no contener caracteres especiales.")
        if not VerificarMascota.raza(raza):
            st.warning("La raza debe tener menos de 20 caracteres y solo incluir letras.")
